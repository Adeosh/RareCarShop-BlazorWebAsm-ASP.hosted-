    ...
    public partial class VersionOne : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarsEquipment", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItems", x => new { x.UserId, x.CarId, x.CarEquipmentId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => new { x.OrderId, x.CarId, x.CarEquipmentId });
                    table.ForeignKey(
                        name: "FK_OrderItems_CarsEquipment_CarEquipmentId",
                        column: x => x.CarEquipmentId,
                        principalTable: "CarsEquipment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceVariants", x => new { x.CarId, x.CarEquipmentId });
                    table.ForeignKey(
                        name: "FK_PriceVariants_CarsEquipment_CarEquipmentId",
                        column: x => x.CarEquipmentId,
                        principalTable: "CarsEquipment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PriceVariants_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_CarEquipmentId",
                table: "OrderItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceVariants_CarEquipmentId",
                table: "PriceVariants",
                column: "CarEquipmentId");
